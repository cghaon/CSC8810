...
def plot_fc_pca(fc1_list,fc_out_list):
    ...
    fig.set_figwidth(15)
    fig.set_figheight(6)
    principalComponents = pca.fit_transform(fc1_list[0])
    axs[0].scatter(principalComponents[:,0], principalComponents[:,1], label=fc1_list[0].shape, alpha=0.5)
    principalComponents = pca.fit_transform(fc_out_list[0])
    axs[0].scatter(principalComponents[:,0], principalComponents[:,1], label=fc_out_list[0].shape, alpha=0.5)
    principalComponents = pca.fit_transform(fc1_list[-1])
    axs[1].scatter(principalComponents[:,0], principalComponents[:,1], label=fc1_list[-1].shape, alpha=0.5)
    principalComponents = pca.fit_transform(fc_out_list[-1])
    axs[1].scatter(principalComponents[:,0], principalComponents[:,1], label=fc_out_list[-1].shape, alpha=0.5)

plot_fc_pca(total_weights_fc1,total_weights_fc_out)
...
plt.plot(np.arange(0,total_iterations,10),gradslist)
plt.xlabel('epoch')
plt.ylabel('grad_norm')
plt.pause(0.1)
plt.plot(np.arange(0,total_iterations,10),losslist)
plt.xlabel('epoch')
plt.ylabel('loss')
plt.pause(0.1)
plt.plot(np.arange(0,total_iterations,10),acclist)
plt.xlabel('epoch')
plt.ylabel('accuracy')